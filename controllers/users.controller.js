...
exports.createUser = async function (req, res) {
    ...
    const user = { mail: mail, password: password, nombre: nombre, apellido: apellido, telefono: telefono }
    try {
...
exports.updateUser = async function (req, res, next) {
    ...
    if (User.nombre && User.apellido && User.telefono && User.mail && User.password) {
        try {
        ...
        return res.status(400).json({ status: 400., message: "Se deben ingresar los campos obligatorios" })
    }
